...
import cool.AST.ASTContructionVisitor;
...
public class Compiler {
    ...
    public static void main(String[] args) throws IOException {
        ...
        var astConstructionVisitor = new ASTContructionVisitor();
        ...
        ((ASTNode)ast).accept(definitionPassVisitor);
        ((ASTNode)ast).accept(resolutionPassVisitor);
